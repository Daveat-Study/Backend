...
# New Project
### Set JRE to able build and run 
1. Inside Preference search
- "Gradle" and change "Gradle JVM" to latest 1
2. In Edit Configuration:
- Set Jvm version to fit with version when you set in Preference.
